...
/* package Hoincare-0.1.0.0 */
#ifndef VERSION_Hoincare
#define VERSION_Hoincare "0.1.0.0"
#endif /* VERSION_Hoincare */
#ifndef MIN_VERSION_Hoincare
#define MIN_VERSION_Hoincare(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Hoincare */
...
#define CURRENT_COMPONENT_ID "Hoincare-0.1.0.0-inplace-Hoincare"
